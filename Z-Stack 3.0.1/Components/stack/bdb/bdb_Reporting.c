...
ZStatus_t bdb_RepChangedAttrValue( uint8 endpoint, uint16 cluster, uint16 attrID )
{
  ...
  {HalLcdWriteString("3333333333333", 3); ///////////////// <<<---
  ...
  if( zclAnalogDataType(attrRec.dataType) )
  {
    ...
    {HalLcdWriteString("444444444444", 3); ///////////////// <<<---
  ...
  //Restart reporting
  bdb_RepStartReporting( );
  HalLcdWriteString("55555555555555555555", 3); ///////////////// <<<---
  return ZSuccess;
}
